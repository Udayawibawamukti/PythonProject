...
def settingMenu():
    input_box1 = InputBox(lebar/2, tinggi/2-50, 140, 32)
    ...
    while setting:
        ...
        btnLoader("OK", "Asset\Button Idle.png", "Asset\Button Act.png", 0.28, 0.18, lebar / 2 + 150, tinggi / 2 + 100,
                  action="quit")

        textCreate("setting", 'Asset\Fine College.ttf', Color(255, 0, 0), SP(lebar / 2, 80, 100, 0))
        ...
        textCreate("Second :", None, Color(255,0,0), SP(lebar/2-150,tinggi/2-50,48,0))
